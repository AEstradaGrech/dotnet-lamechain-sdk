...
namespace Dotnet.OllamaSharp.LameChain.SDK.Interfaces.Command.Services
{
    public interface IPromptCommandsService
    {
        ...
        Task<string> StringBoolChoice(string prompt, string? guidanceMessage = null, bool isGuidanceAppend = false, CommandSettings settings = null);
        ...
        Task<ScoredBoolResponse> ScoredBool(string prompt, string? instrucion = null, bool isGuidanceAppend = false, CommandSettings settings = null);
        
        Task<ScoredStringChoice> ScoredChoice(List<string> choices, string prompt, string? instrucion = null, bool isGuidanceAppend = false, CommandSettings settings = null);
    }
}
